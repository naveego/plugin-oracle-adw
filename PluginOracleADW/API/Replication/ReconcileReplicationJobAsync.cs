...
using ConfigureReplicationFormData = PluginOracleADW.DataContracts.ConfigureReplicationFormData;
...
namespace PluginOracleADW.API.Replication
{
    public static partial class Replication
    {
        ...
        public static async Task ReconcileReplicationJobAsync(IConnectionFactory connFactory, PrepareWriteRequest request)
        {
            ...
            var safeSchemaName = replicationSettings.Owner;
            ...
            else
            {
                ...
                var previousGoldenTable = ConvertSchemaToReplicationTable(previousMetaData.Request.Schema, previousReplicationSettings.Owner, previousReplicationSettings.GoldenTableName);

                var previousVersionTable = ConvertSchemaToReplicationTable(previousMetaData.Request.Schema, previousReplicationSettings.Owner, previousReplicationSettings.VersionTableName);

                // check if schema changed
                if (previousReplicationSettings.Owner != replicationSettings.Owner)
                {
